...
#+BEGIN_SRC emacs-lisp
  (setq user-full-name "Ivo Verberk"
    user-mail-address "ivo.verberk@gmail.com")
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Set path for darwin
  (when (system-is-mac)
    (setenv "PATH" (concat (getenv "PATH") ":/Users/iverberk/.nix-profile/bin:/usr/bin"))
    (setq exec-path (append '("/Users/iverberk/bin" "/profile/bin" "/Users/iverberk/.npm-packages/bin" "/Users/iverberk/.nix-profile/bin" "/nix/var/nix/profiles/default/bin" "/usr/local/bin" "/usr/bin") exec-path)))
#+END_SRC
